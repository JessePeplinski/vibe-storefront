...
Vibe Storefront is a Next.js App Router prototype for turning product ideas into shareable storefront concepts. A signed-in user enters a plain-English product idea, the server calls the OpenAI Codex SDK for structured storefront content, saves it to Supabase, and returns a public share URL.
