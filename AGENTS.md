...
Vibe Storefront is a Next.js App Router demo for the OpenAI Codex Solutions Architect take-home. A signed-in user enters a product idea, the server calls the Codex SDK for structured storefront content, saves it to Supabase, and exposes a public share URL.
