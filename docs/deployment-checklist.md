...
- Signed-in generation succeeds for the first five storefronts on a new account.
- A sixth different signed-in generation attempt is blocked by the five-storefront quota.
