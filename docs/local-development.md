...
6. Try to generate a sixth different storefront from the same signed-in account and confirm the five-storefront limit blocks it without another generation.
